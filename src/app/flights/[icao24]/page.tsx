        ...
        ">
            ...
            <section className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                value={
                    ...
                    ? `${data.distance_over_area} km`
                    : "—"
                }
                    />
                <Info label ="First seen" value={new Date(data.first_seen).toLocaleString("en-GB")} />
                <Info label ="Last seen" value={new Date(data.last_seen).toLocaleString("en-GB")} />
            </section>
        </main>
    );
}
